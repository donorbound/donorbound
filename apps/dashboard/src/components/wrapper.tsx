...
export function Wrapper(properties: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex justify-center">
      ...
      <div className="mt-20 lg:w-7/12 w-full">{properties.children}</div>
    </div>
  );
}
...
export function WrapperWithQuery(properties: { children: React.ReactNode }) {
  return (
