...
interface BetterAuthResetPasswordEmailProperties {
  username?: string;
  resetLink?: string;
}
...
export const ResetPasswordEmail = ({
  resetLink,
  username,
}: BetterAuthResetPasswordEmailProperties) => {
...
export function reactResetPasswordEmail(
  properties: BetterAuthResetPasswordEmailProperties,
) {
  console.log(properties);
  return <ResetPasswordEmail {...properties} />;
}
