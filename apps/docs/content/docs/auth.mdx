...
description: "How to authenticate your requests to Donorbound's API"
---
...
When requesting resources, you will need your root key — you will find it in the [Dashboard](https://app.donorbound.com/settings/root-keys). Here's how to add the root key to the request header using cURL:
